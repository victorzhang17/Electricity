    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        try {
            if (msg instanceof FullHttpRequest) {
                ...
                errorCode = HTTP_OBJECT_TYPE_IS_NOT_FULLHTTPREQUEST;
                throw new ElectricityException("NETTY服务器，HTTP传输对象类型非FullHttpRequest",HTTP_OBJECT_TYPE_IS_NOT_FULLHTTPREQUEST);
            }
